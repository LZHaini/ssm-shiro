...
<head>
    ...
    <script type="text/javascript">
        ...
        function roleSearch() {
            ...
            console.log(status);
            //通过options可以获取他的方法queryParams，url等等
            $("#roleWin").datagrid("options").queryParams = {
                rolename: rolename,
                rolecode: rolecode,
                status: status,
            }
            $("#roleWin").datagrid("options").url = path + "/role/queryRole";
            $("#roleWin").datagrid("load");
        }
...
<div id="roletb" style="padding:2px 5px;">
    ...
    <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="roleSearch()">搜 索</a>
    <a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="roleAdd()">增 加</a>
</div>

<div id="roleEditWin" style="padding:5px;" align="center">
