...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteAuthTree(id) {
            var node = $("#authTree").treegrid("getSelected");
            var id = $("#id").val(node.id).val();
            alert($("#id").val(node.id).val());
            $.ajax({
...
<div id="mm" class="easyui-menu" style="width:120px;">
    ...
    <div onclick="deleteAuthTree(15)" data-options="iconCls:'icon-reload'">删除</div>
...
<div id="authEditWin" style="padding:10px 10px;" align="center">
    ...
    <div style="margin-bottom:10px">
        <input class="easyui-textbox" id="pname" label="上级节点:" data-options="disabled:true" labelPosition="left"
               style="width:90%;">
    </div>
    <div style="margin-bottom:10px">
    ...
    <div style="margin-bottom:10px">
        <select class="easyui-combobox" id="type" label="类型:" data-options="panelHeight:'auto',editable:false"
