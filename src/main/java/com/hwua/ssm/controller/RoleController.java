...
//如果不写自动注入会报空指针
    ...
    @RequiresPermissions("role_query")
    @ResponseBody
    ...
    @RequestMapping(value = "/saveOrUpRole", produces = "text/html;charset=UTF-8")
    @RequiresPermissions("role_edit")
    @ResponseBody
    public String saveOrUpRole(Role role) {
    ...
    @RequiresPermissions("role_grant")
    @ResponseBody
